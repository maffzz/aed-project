...
- ⏱️ Se ilustra la búsqueda de patrones con complejidad aproximada **O(m log n)**.
...
👉 [https://maffzz.github.io/aed-suffix-array](https://maffzz.github.io/aed-suffix-array)
